                ...
                <div class="flex flex-col gap-5 mt-5 sm:flex-row sm:items-center sm:justify-end sm:mt-0 sm:ps-5">
                    <div>
                      <span class="py-1 px-1.5 inline-flex items-center gap-x-1 text-xs font-medium bg-blue-100 text-blue-800 rounded-full dark:bg-blue-500/10 dark:text-blue-500">
                        ...
                        <strong>{{$championshipResult['team_status']}}</strong>
                      </span>
                    </div>
                    ...
                    <div>
                      <span class="py-1 px-1.5 inline-flex items-center gap-x-1 text-xs font-medium bg-red-100 text-red-800 rounded-full">
                        ...
                        Tarjetas Rojas {{$championshipResult['red_cards']}}
                      </span>
                    </div>
                    ...
                    <div>
                      <span class="py-1 px-1.5 inline-flex items-center gap-x-1 text-xs font-medium bg-yellow-100 text-yellow-800 rounded-full">
                        ...
                        Tarjetas Amarillas {{$championshipResult['yellow_cards']}}
                      </span>
                    </div>
                    ...
                    <div>
                      <span class="py-1 px-2 inline-flex items-center gap-x-1 text-xs font-medium bg-teal-100 text-teal-800 rounded-full">
                        ...
                        Total Goles {{$championshipResult['goals']}}
                      </span>
                    </div>

                    <div>
                      <span class="py-1 px-1.5 inline-flex items-center gap-x-1 text-xs bg-gray-100 text-gray-800 rounded-md">
                        <svg class="flex-shrink-0 size-3" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                          <polyline points="22 7 13.5 15.5 8.5 10.5 2 17"></polyline>
                          <polyline points="16 7 22 7 22 13"></polyline>
                        </svg>
                        Partidos Ganados {{$championshipResult['won_games']}}
                      </span>
                    </div>
                    ...
                    <div>
                      <span class="py-1 px-1.5 inline-flex items-center gap-x-1 text-xs bg-gray-100 text-gray-800 rounded-md">
                        ...
                        Partidos Perdidos {{$championshipResult['lost_games']}}
                      </span>
                    </div>
                </div>
            </div>
